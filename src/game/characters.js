...
export const CHARACTERS = {
  ...
  // เจ้าหน้าที่ 1669 ปลายสาย — โผล่ได้เฉพาะหลังผู้เล่นสั่งโทร 1669 แล้ว (option ที่มี call1669: true)
  // ก่อนโทร เสียง mentor เป็นครูฟ้า (kru_fah) — FirstAidGame.jsx สลับตาม state.called1669 ห้ามลบทั้งคู่
  opr_1669: {
    name: 'จนท. 1669',
  ...
  // ครูปฐมพยาบาล — เสียงบทเรียนในหัวผู้เล่น: ชี้แนะ/ดุก่อนโทร 1669 + ชมและสรุปบทเรียนตอนจบเคส
  kru_fah: {
    name: 'ครูฟ้า',
    role: 'ครูปฐมพยาบาล',
    plate: ['#D98A2B', '#96570F'],
